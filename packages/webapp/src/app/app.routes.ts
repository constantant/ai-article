...
export const appRoutes: Route[] = [
  {
    path: '',
    loadComponent: () =>
      import('./pages/app-list/app-list').then((m) => m.AppListComponent),
    resolve: { apps: appListResolver },
  },
  {
    path: 'app/:appId',
    loadComponent: () =>
      import('./pages/app-home/app-home').then((m) => m.AppHomeComponent),
    resolve: {
      profile: appProfileResolver,
      articles: publishedArticlesResolver,
    },
  },
  {
